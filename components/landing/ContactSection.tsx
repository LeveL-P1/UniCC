...
export function ContactSection() {
  return (
    <section id="contact" className="w-full relative flex items-center justify-center py-0">
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12 bg-black/20 backdrop-blur-sm border border-white/5 rounded-3xl p-12 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-10">
          ...
          >
            <h3 className="text-2xl text-white mb-3 uppercase tracking-[0.2em] font-light">Contact Info</h3>
        ...
        >
          <h3 className="text-2xl text-white mb-6 uppercase tracking-[0.2em] font-light">Message </h3>
          ...
          <form className="flex flex-col gap-10" onSubmit={(e) => e.preventDefault()}>
            ...
            <textarea 
              ...
              rows={4}
              className="w-full bg-transparent border-b border-white/20 pb-1 text-white text-lg outline-none focus:border-white/60 transition-colors placeholder:text-neutral-600 resize-none"
            />

            <button 
              type="submit" 
              className="mt-6 self-start bg-white text-black px-10 py-3 text-sm  font-bold uppercase tracking-[0.15em] hover:bg-neutral-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] rounded-sm cursor-pointer "
            >
              Send Message
            </button>
          </form>
