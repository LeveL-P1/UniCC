...
export const CyberButton: React.FC<CyberButtonProps> = ({ onClick }) => {
  return (
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  ...
  .btn {
    ...
    --padding: 4px;
    --transition: 0.4s;
    --button-color: #411a8d; /* Same as background */
    --highlight-color-hue: 260deg; /* Adjusted to match the purple aesthetic */
